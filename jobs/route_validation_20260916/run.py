...
try:
 for mc in manifest:
  ...
  if args.retry and slug not in args.retry:continue   # an explicit retry list is the whole job: a fleet worker's 'running' row synced into maps/ must not be re-run here
