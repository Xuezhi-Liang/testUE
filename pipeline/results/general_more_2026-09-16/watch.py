...
r=Path(__file__).resolve().parent;s=Path('/home/ubuntu/WM-Unreal-data-collection/local_run/site/longvideo/general-stability-more');previous=None;worker=None;processed={};cfg=json.loads((r/'config.json').read_text())
