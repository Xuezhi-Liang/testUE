# Game_SuburbNeighborhoodHousePack_Maps_DemoMap_Day_Lumen__nested_out_and_back__age35__seed10__batch5_suburb_v3

Map `/Game/SuburbNeighborhoodHousePack/Maps/DemoMap_Day_Lumen`, spawn `test1`, seed 10.
Recorded with `pipeline/capture.py` (pipeline-capture-engine-1) from the frozen trajectory
`11dce0f291d9f500`, UE 5.8.
