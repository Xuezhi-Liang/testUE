# Game_MiddleEast_Maps_MiddleEast__nested_out_and_back__age35__seed13__batch6_middleeast

Map `/Game/MiddleEast/Maps/MiddleEast`, spawn ``, seed 13.
Recorded with `pipeline/capture.py` (pipeline-capture-engine-1) from the frozen trajectory
`6d3f31210403c4cd`, UE 5.8.
