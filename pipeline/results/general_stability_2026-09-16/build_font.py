...
r=Path(__file__).resolve().parent;s=Path('/home/ubuntu/WM-Unreal-data-collection/local_run/site/longvideo/general-stability')
...
chars=''.join(sorted({c for c in text if '\u4e00'<=c<='\u9fff'}))
