# Game_TokyoStylizedEnvironment_Maps_Tokyo__nested_out_and_back__age35__seed2__batch5_tokyo

Map `/Game/TokyoStylizedEnvironment/Maps/Tokyo`, spawn `test1`, seed 2.
Recorded with `pipeline/capture.py` (pipeline-capture-engine-1) from the frozen trajectory
`04201a5b63ed34a6`, UE 5.8.
