...
import boto3
F = Path('/home/ubuntu/ue_newroute_fleet_20260916'); R = Path('/home/ubuntu/ue_newroute_20260916')
SITE = Path('/home/ubuntu/WM-Unreal-data-collection/local_run/site/longvideo/route-queue'); SITE.mkdir(parents=True, exist_ok=True)
B, PRE = 'pan-simworld', 'ue-newroute/20260916/'
...
def once():
    ...
    inst = {}
    try:
        for res in ec.describe_instances(Filters=[{'Name': 'tag:NewRouteRun', 'Values': ['20260916']}])['Reservations']:
