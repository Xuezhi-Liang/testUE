...
try:
 ...
 assert bounded_call('UnrealCV first status',original_request,'vget /unrealcv/status',timeout_s=int(mc.get('first_rpc_s') or os.environ.get('FIRST_RPC_S',1500))),'Empty UnrealCV status'
 cl.request=request
