...
<h2 style="margin:0 0 8px">当前录制配置 · 2026-09-17</h2>
<p style="margin:0 0 10px">TAA · 2× 超采样 · 720p / 24fps · 按地图补光。包含镜头、光照、曝光、抗锯齿、深度与编码参数。</p>
<p style="margin:0 0 10px"><a href="recording-config.html">在线阅读配置</a> · <a href="recording-config.md" download="UE-recording-config-2026-09-17.md">下载 Markdown</a> · <a href="stability_detail_candidate.json" download>下载模板 JSON</a></p>
...
<nav><a href="./">← 返回闪烁修复页面</a><a href="recording-config.md" download="UE-recording-config-2026-09-17.md">下载 Markdown</a><a href="stability_detail_candidate.json" download>下载模板 JSON</a></nav>
